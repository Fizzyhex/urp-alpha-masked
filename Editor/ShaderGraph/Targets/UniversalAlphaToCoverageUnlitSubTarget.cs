...
{
    /// <summary>
    /// URP Unlit Shader Graph target that forces alpha-to-coverage for opaque,
    /// alpha-clipped forward passes. Use with an MSAA-enabled URP renderer.
    /// </summary>
    sealed class UniversalAlphaToCoverageUnlitSubTarget : UniversalSubTarget, ILegacyTarget
    {
        static readonly GUID kSourceCodeGuid = new GUID("5e02291df2e347e9be07ad10374e0a45"); // UniversalAlphaToCoverageUnlitSubTarget.cs
        ...
        public UniversalAlphaToCoverageUnlitSubTarget()
        {
            displayName = "Unlit Alpha To Coverage";
        }
        ...
        {
            internal static void AddLightingVariantsControlToPass(ref PassDescriptor pass, UniversalAlphaToCoverageUnlitSubTarget unlitSubTarget)
            {
            ...
            internal static void AddDefaultDecalBlendingControlToPass(ref PassDescriptor pass, UniversalAlphaToCoverageUnlitSubTarget unlitSubTarget)
            {
            ...
            internal static void AddDefaultSSAOControlToPass(ref PassDescriptor pass, UniversalAlphaToCoverageUnlitSubTarget unlitSubTarget)
            {
            ...
            public static PassDescriptor Forward(UniversalTarget target, KeywordCollection keywords)
            {
                ...
                // Unlike the stock target, do not defer to the material's
                // _AlphaToMask property when material overrides are enabled.
                // The custom target guarantees the literal shader directive:
                // AlphaToMask On.
                ...
                if (target.activeSubTarget is UniversalAlphaToCoverageUnlitSubTarget unlitSubTarget)
                {
